...
export async function GET(request: NextRequest) {
  ...
  const airQualityUrl = `https://air-quality-api.open-meteo.com/v1/air-quality?latitude=${latitude}&longitude=${longitude}&hourly=pm10,pm2_5,ozone,nitrogen_dioxide,aerosol_optical_depth_400nm,aerosol_optical_depth_1020nm&current=us_aqi&timezone=auto&forecast_days=6`;
