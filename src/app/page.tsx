      ...
      <div className="container mx-auto p-4">
        ...
        <div className="flex flex-col gap-4 overflow-x-auto pb-4 lg:flex-row">
          ...
          {predictions.map((prediction) => (
            <Card
              key={prediction.date}
              className={`w-full flex-shrink-0 bg-gradient-to-br lg:w-1/6 ${getScoreGradient(prediction.score.score).color} peer h-full transition-all duration-300 ease-in-out hover:z-10 hover:scale-105 peer-hover:opacity-50`}
              style={{ filter: `saturate(${getScoreGradient(prediction.score.score).saturation}%)` }}
            >
